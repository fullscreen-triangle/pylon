...
\draw[thick] (0,2.5) rectangle (4,4);
\node at (2,3.25) {Temporal\\Fragmentation};

\draw[thick] (4,2.5) rectangle (8,4);
\node at (6,3.25) {Precision-by-Difference\\Calculator};

\draw[thick] (8,2.5) rectangle (12,4);
\node at (10,3.25) {Preemptive State\\Generator};

\draw[thick] (0,4) rectangle (12,5);
\node at (6,4.5) {Application Layer};
\end{tikzpicture}
